...
-- Tiempo de generación: 27-01-2025 a las 15:56:46
...
(5, 2, 18, 0.00000000, 0.00000000),
(6, 7, 18, 0.00000000, 0.00000000),
(7, 8, 18, 0.00000000, 0.00000000);
...
(13, '8326547', 'Mishel Comprador', '73512839', 'mishelcalle735n@gmail.com', '$2y$10$EstXPvLYdWrzMWGmelLvGuqgRYVj4nTKtIssV8JkEA8LwGKfF.ZB.', 1, NULL, NULL, 3, 'ninguno'),
...
(18, '1111111', 'persona1', '77777777', 'fajes74338@downlor.com', '$2y$10$Lg6jEJFbBjDsxkP8D6uPKeZVYwf4cp97LbxxlXVCTExqjpL1C2fOi', 1, NULL, NULL, 1, 'ninguno');
...
--
ALTER TABLE `pedido`
  MODIFY `idped` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
